...
import { Home, UserPlus, Users, Upload, History, LogOut } from "lucide-react";
...
export default function AdminSidebar() {
  ...
  return (
    <div className="w-64 h-screen bg-gradient-to-b from-gray-900 to-gray-950 text-white flex flex-col border-r border-gray-800">
      ...
      <div className="p-4 border-t border-gray-800">
        <button
          ...
          className="w-full flex items-center justify-center gap-2 p-3 rounded-lg font-medium transition-all
            ...
            text-red-300 hover:text-white border border-red-900/30"
        >
          <LogOut size={20} />
          Logout
        </button>
